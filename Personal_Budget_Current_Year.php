...
<head>
    ...
    <title>Personal_Budget_Current_Year</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css"
        integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
    <link href="https://fonts.googleapis.com/css2?family=Lato&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="Personal_Budget_Current_Year.css">
</head>
...
<body>
    ...
    elseif(isset($positive_balance)){
        echo "<div class='text-center mt-3 bg-white font-weight-bold h5'>"; ?>
                    <span style="color: #74aa54;"><?php echo "Balance: $total_balance PLN $positive_balance"; ?></span> <?php
        echo "</div>";
    }else{
    ...
    ?>
    <div class=" text-center mt-3 text-danger bg-white font-weight-bold h5">
